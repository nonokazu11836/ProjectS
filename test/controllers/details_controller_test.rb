...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { picture_id: @detail.picture_id, student_id: @detail.student_id } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { picture_id: @detail.picture_id, student_id: @detail.student_id } }
